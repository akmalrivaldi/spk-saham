                ...
                <div class="card login-card">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold mb-1" style="color: var(--text-dark);">Selamat Datang</h3>
                            <p class="text-muted small">Sistem Pendukung Keputusan Pemilihan Saham</p>
                        </div>
                        ...
                        <form action="{{ route('login.post') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="user@example.com">
                                </div>
                                @error('email')
                        ...
                        <div class="mt-4 text-center">
                            <span class="text-muted small">
                                Belum punya akun? <a href="{{ route('register') }}" class="text-decoration-none fw-bold" style="color: var(--primary-color);">Daftar di sini</a>
                            </span>
                        </div>
                    </div>
                </div>
